"""
Django settings for EduWeConnect project.
...
SECRET_KEY = 'django-insecure-ldno0da*)$@7)+sv(**v_xmiv_(r1r=r@m4owq^&kjig7=$*^c'
...
ROOT_URLCONF = 'EduWeConnect.urls'
...
WSGI_APPLICATION = 'EduWeConnect.wsgi.application'
